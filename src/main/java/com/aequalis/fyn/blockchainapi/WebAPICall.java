 ...
 * 
 */
package com.aequalis.fyn.blockchainapi;
...
import com.aequalis.fyn.dto.UserDTO;
...
public class WebAPICall {
	...
	public static void setProperties() {
		if (BLOCKCHAIN_BASE.equals("")) {
			...
			try {
				properties.load(Thread.currentThread().getContextClassLoader().getResourceAsStream("fyn.properties"));
